...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_iter', default=27350, type=float, help='maximum training iteration')
    parser.add_argument('--batch_size', default=128, type=int, help='batch size')
    parser.add_argument('--mode', default='train', type=str, help='name of the experiment')
